...
def rag_pipeline(query: str, sender_id: str):
    ...
    system_prompt_content = (
        ...
        "Do not use em dashes, make sure your final response has a good flow and easy to read and is generally natural and human sounding."
    )
...
def is_medical_query_and_respond(text: str, sender_id: str, language='en'):
    ...
    if language == 'ar':
        ...
        system_prompt = (
            "You are a friendly and helpful assistant. RESPOND TO EVERYTHING WITH ONLY 'MEDICAL_QUERY' with nothing else, UNLESS it is a GREETING or a PLEASANTRY such as THANK YOU then respond naturally and smartly, or general english words like 'good' and 'okay', 'fine' and everything that has nothing to do with medicine or the NBME "
        )
